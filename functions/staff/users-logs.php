<?php
include_once 'menu/offcanva-menu.php';
include_once 'authentication.php';
include_once 'tables/datatables.php';
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Users Logs - MGARDEN</title>
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-success py-2" data-bs-toggle="tooltip" data-bss-tooltip="" title="Here you can see your total users logs.">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>TOTAL USERS Logs</span></div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-success py-2" data-bs-toggle="tooltip" data-bss-tooltip="" title="Here you can see your latest user added.">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
    ...
    <div class="card-header py-3">
        <p class="text-success m-0 fw-bold">Activity Logs</p>
    </div>
    <div class="card-body">
...
<script>
    $(document).ready(function () {
        // Initialize DataTable with pagination and scroll options
        $('#dataTable').DataTable({
