...
include_once 'functions/tables/get-data.php';
                ...
                <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><img src="assets/img/icon.png" width="32"><span> M Garden Beach Resort</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse" id="navcol-1">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item"><a class="nav-link active" href="rent.php">Reservation List</a></li>
            ...
            <div class="container py-4 py-xl-5">
                <div id="content">
                    <div class="container-fluid">
                        ...
                        $sql = "SELECT fullname, phone, address FROM `customers` WHERE phone = (SELECT phone FROM users WHERE id = :id) AND address = (SELECT address FROM users WHERE id = :id)";
                        $stmt = $db->prepare($sql);
                        ...
                        // Assign variables for name, address, and phone
                        $fullname = $result['fullname'];
                        $phone = $result['phone'];
                        $address = $result['address'];

                        // // Output the result using the assigned variables
...
<div class="card shadow mb-4">
    ...
    <form>
        <div class="row">
            <div class="col">
                <input class="form-control" type="text" hidden id="first_name" placeholder="John" name="first_name" readonly="" value="<?php echo $fullname; ?>">
            </div>
        </div>
        <input class="form-control" type="text" hidden placeholder="Address" name="address" readonly="" value="<?php echo $address; ?>">
</div>
<input class="form-control" type="text" hidden placeholder="Contact" name="address" readonly="" value="<?php echo $phone; ?>">
</div>
</form>
                    </div>
                    <hr>
    ...
    <footer class="bg-primary-gradient">
        <div class="container py-4 py-lg-5">
            ...
            <div class="text-muted d-flex justify-content-between align-items-center pt-3">
                <p class="mb-0">Copyright © MGARDEN 2024</p>
