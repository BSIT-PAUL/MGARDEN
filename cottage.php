            ...
            <div id="content">
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Cottage Management</h3>
                        <a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="#" data-bs-target="#add" data-bs-toggle="modal" data-bs-toggle="tooltip" data-bss-tooltip="" title="Heres you can add new cottage"><i class="fas fa-user fa-sm text-white-50"></i>&nbsp;Add Cottage</a>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-success py-2" data-bs-toggle="tooltip" data-bss-tooltip="" title="Heres your latest cottage added.">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-1"><label class="form-label">Name</label><input class="form-control" type="text" name="name" required="" placeholder="Name">
                    ...
                    <div class="mb-1"><label class="form-label">Price Pakage</label><input class="form-control" type="number" name="pricePackage" required="" value="0">
                        <div class="invalid-feedback">
                            Please enter your price.
                        </div>
                    </div>
